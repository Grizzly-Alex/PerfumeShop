...
public sealed class SaleDbInitializer : IDbInitializer
{
	...
	private IEnumerable<PhysicalShop> GetPhysicalShops() 
		...
		{
			new (new ("Germany", "Berlin", "Rosenthaler Str. 35", "10115"),
				new TimeOnly(08,00,00), new TimeOnly(18,00,00),
				new List<DayOfWeek>()
				{
					DayOfWeek.Saturday,
					DayOfWeek.Sunday
			...
			new (new ("Germany", "Hamburg", "Ludwig Str. 12", "20535"),
				new TimeOnly(09,00,00), new TimeOnly(20,00,00),
				new List<DayOfWeek>()
				{
					DayOfWeek.Saturday,
					DayOfWeek.Sunday
			...
			new (new ("Germany", "Dresden", "Wiener Str. 21", "1099"),
				new TimeOnly(08,00,00), new TimeOnly(18,00,00),
				new List<DayOfWeek>()
				{
					DayOfWeek.Saturday,
